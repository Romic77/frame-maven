...
public class EncryptUtil {
	...
	public static String getKey() {
		String key="";
		String mingwenkey = "chenqi7758258AXS";
		try {
			byte[] b = mingwenkey.getBytes("utf-8");
			key= new BASE64Encoder().encode(b);
	...
	public static void main(String[] args) throws Exception {
		 ...
		 System.out.println(decrypt("4753eopVDmfL8THzzeQXI4DChzzw4QB6"));
	}
}