 ...
 */
public class ActimeMQConsumer3 {
	...
	public static final String CONDITION = "age>=25";
	...
	public static void main(String[] args) throws JMSException, InterruptedException {
		...
		MessageConsumer messageConsumer = session.createConsumer(destination, CONDITION);

		messageConsumer.setMessageListener(new Listener());
		TimeUnit.SECONDS.sleep(4);  //让主线程 等待4秒等异步的listener监听程序执行完毕
	 ...
	 */
	public static ConnectionFactory getConnectionFactory() throws InterruptedException {
